...
const GameArea: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col gap-4 max-w-full overflow-visible bg-amber-50/90 dark:bg-amber-900/30 backdrop-blur-sm rounded-2xl p-4 shadow-xl border-2 border-amber-300/80" style={{
